...
import com.example.oday.databinding.FriendRvSampleBinding;
...
public class FrollowersAdapter extends RecyclerView.Adapter<FrollowersAdapter.viewHolder> {

    ArrayList<Follow> list;
    Context context;

    public FrollowersAdapter(ArrayList<Follow> list, Context context) {
        this.list = list;
