...
import com.example.oday.databinding.ActivityCommentBinding;
...
public class CommentActivity extends AppCompatActivity {
        ...
        database.getReference()
                ...
                .child( "comments" ).addValueEventListener( new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        binding.scrollView3.fullScroll( binding.scrollView3.FOCUS_DOWN );
    ...
    /*@Override
    public  boolean onOptionsIteamSelected(@NonNull MenuItem item){
        finish();
